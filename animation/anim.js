...
jQuery(function($){	
	...
	// icon.insert(TweenMax.to($('.carousel .icon.a'), .5, {css:{top:0,scale:.5,opacity:.5}, ease:Circ.easeNone, repeat:1, yoyo:true}));

	//then both these tweens start
	// icon.to($('.carousel .icon.a'), 1, {css:{right:0},ease:Linear.easeNone});
	// icon.insert(TweenMax.to($('.carousel .icon.a'), .5, {css:{top:75,scale:1,opacity:1}, ease:Circ.easeNone, repeat:1, yoyo:true}), 1);
